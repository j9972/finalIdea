...
function NaverMap(appSiteInfo, setAppSiteInfo) {
  ...
  //console.log("appSiteInfo:", appSiteInfo);

  //.appSiteInfo[0];

  // let lng = parseInt(infoOfPlace.mapx, 10);
  // let lat = parseInt(infoOfPlace.mapy, 10);
  ...
  }, [location]); // location값이 변경 될때마다 useEffect 값 호출
